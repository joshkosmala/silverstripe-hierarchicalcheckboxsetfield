...
class HierarchicalCheckboxSetField extends CheckboxSetField
{
    ...
    public function __construct($name, $title = "", $source = array(), $childsource = null, $value = "", $form = null, $childfilter = null)
    {
    ...
    public function getChildOptions($item)
    {
    ...
    public function disableParentsWithChildren($setting = true)
    {
    ...
    public function setChildFilter($filter)
    {
    ...
    public function setChildSort($sort)
    {
        $this->childsort = $sort;
